...
@section('content')
    <div class="admin-room-form">
        ...
        <div class="admin-room-form__header">
            <h1 class="admin-room-form__title">Добавить номер</h1>
            ...
            <div class="admin-room-form__grid">
                ...
                <div class="admin-room-form__main">
                    ...
                    <div class="admin-card admin-card--form">
                        ...
                        <div class="admin-form__field">
                            ...
                            <textarea
                                ...
                                name="description"
                                rows="4"
                                placeholder="Описание номера">{{ old('description') }}</textarea>
                            @error('description')
                            <span class="admin-form__error">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="admin-card admin-card--form">
                        ...
                        <p class="admin-form__hint admin-form__hint--block">Отметьте доступные удобства:</p>
                ...
                <div class="admin-room-form__sidebar">
                    <div class="admin-card admin-card--sidebar">
                        ...
                        <div class="admin-form__field">
                            <label for="images" class="admin-form__label">Загрузить фото</label>
                            <input
                                type="file"
...
@push('scripts')
    <script defer src="{{ asset('js/admin-room-image-upload.js') }}"></script>
@endpush
